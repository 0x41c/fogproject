  ...
  if ((($.ui.timepicker = $.ui.timepicker || {}), !$.ui.timepicker.version)) {
    ...
    $.extend(Timepicker.prototype, {
                ...
                ? (-1 !== g.t &&
                  ...
                  -1 !== g.h &&
                    ("AM" === h && "12" === i[g.h]
                      ...
                      : (j.hour = Number(i[g.h]))),
                  -1 !== g.m && (j.minute = Number(i[g.m])),
                  -1 !== g.s && (j.second = Number(i[g.s])),
                  -1 !== g.l && (j.millisec = Number(i[g.l])),
                  -1 !== g.c && (j.microsec = Number(i[g.c])),
                  -1 !== g.z &&
                    void 0 !== i[g.z] &&
      ...
      ($.datepicker._gotoToday = function (a) {
        ...
        var c = this._get(b, "timepicker"),
          d = $.timepicker.timezoneOffsetNumber(c.timezone),
          e = new Date();
        e.setMinutes(e.getMinutes() + e.getTimezoneOffset() + d),
          this._setTime(b, e),
          this._setDate(b, e),
          c._onSelectHandler();
      }),
          ...
          d instanceof Date
            ...
            e &&
              ...
              (e.support.timezone ||
                ...
                (e.timezone = -1 * f.getTimezoneOffset()),
              (d = $.timepicker.timezoneAdjust(d, e.timezone)),
              (f = $.timepicker.timezoneAdjust(f, e.timezone))),
            this._updateDatepicker(c),
            this._base_setDateDatepicker.apply(this, arguments),
            ...
            return (
              e &&
                ...
                null != d.timezone &&
                  ...
                  (e = $.timepicker.timezoneAdjust(e, d.timezone)))),
              e
            );
          }
    ...
    ($.timepicker = new Timepicker()),
      ...
      ($.timepicker.timezoneAdjust = function (a, b) {
        ...
        return (
          isNaN(c) || a.setMinutes(a.getMinutes() + -a.getTimezoneOffset() - c),
          a
        );
      }),
