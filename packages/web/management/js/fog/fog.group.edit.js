(function ($) {
  ...
  $("#delAllPM").on("click", function () {
    $("#delAllPMBox").html(
      "Are you sure you wish to remove all power management tasks with this group?"
    );
    $("#delAllPMBox").dialog({
      resizable: false,
      modal: true,
  ...
  checkboxAssociations(
    ".toggle-checkboxprint:checkbox",
    ".toggle-print:checkbox"
  );
  checkboxAssociations(
    ".toggle-checkboxprintrm:checkbox",
    ".toggle-printrm:checkbox"
  );
  checkboxAssociations(
    ".toggle-checkboxsnapin:checkbox",
    ".toggle-snapin:checkbox"
  );
  checkboxAssociations(
    ".toggle-checkboxsnapinrm:checkbox",
    ".toggle-snapinrm:checkbox"
  );
  checkboxAssociations(
    "#rempowerselectors:checkbox",
    ".rempoweritems:checkbox"
  );
