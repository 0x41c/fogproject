(function ($) {
  ...
  if ($("#snapinpack-name").val().length < 1)
    $("#snapinpack-name").attr("placeholder", name);
  if ($("#snapinpack-version").val().length < 1)
    $("#snapinpack-version").attr("placeholder", version);
  if ($("#snapinpack-file").val().length < 1)
    $("#snapinpack-file").attr("placeholder", file);
  if ($("#snapinpack-arguments").val().length < 1)
    $("#snapinpack-arguments").attr("placeholder", argument);
